...
func Kook() func(ctx *gin.Context) {
	s := khl.New(core_utils.GetKaiheilaBotToken(), plog.NewLogger(log.GetLogger()), khl.SessionWithEncryptKey([]byte(core_utils.GetKaiheilaBotEncryptKey())), khl.SessionWithVerifyToken(core_utils.GetKaiheilaBotVerifyToken()))
